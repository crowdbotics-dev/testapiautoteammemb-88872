...
## Project Structure
    ...
    ├── testapiautoteammemb_88872  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_88872`
...
2. Clone this repo and `cd testapiautoteammemb_88872`
